...
class ComfyUI:
    ...
    def run_server(self, output_directory, input_directory):
        command = f"/src/venv/bin/python ComfyUI/main.py --output-directory {output_directory} --input-directory {input_directory} --listen 0.0.0.0 --disable-metadata --highvram"        """
